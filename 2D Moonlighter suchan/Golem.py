...
class IdleState:
    ...
    def draw(golem):
            ...
            golem.GolemIdle.clip_draw(int(golem.frameRL) * 89, 345, 89, 115, golem.x, golem.y)

            golem.GolemIdle.clip_draw(int(golem.frameRL) * 89, 345, 89, 115, golem.x1, golem.y1)

            golem.GolemIdle.clip_draw(int(golem.frameRL) * 89, 345, 89, 115, golem.x2, golem.y2)
         # else:
...
class Golem:
    ...
    def __init__(self):
        ...
        self.GolemIdle = load_image('Golem_Idle.png')
        self.dirRL = 1
        self.dirUD = 1
